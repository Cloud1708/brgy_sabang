...
if ($username === '' || $password === '') {
    header('Location: ../parent_login.php?error=1'); exit;
}
...
$stmt = $mysqli->prepare("
    ...
    LIMIT 1
");
if(!$stmt){ header('Location: ../parent_login.php?error=db'); exit; }
