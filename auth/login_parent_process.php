...
if ($username === '' || $password === '') {
    header('Location: ../parent_login?error=1'); exit;
}
...
$stmt = $mysqli->prepare("
    ...
    LIMIT 1
");
if(!$stmt){ header('Location: ../parent_login?error=db'); exit; }
